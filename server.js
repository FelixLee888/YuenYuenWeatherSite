...
async function handleApi(req, res, requestUrl) {
  ...
  if (pathname === "/api/weather" && req.method === "GET") {
    ...
    const benchmark = buildBenchmarkData(bundle.benchmark, bundle.history, resolvedLocation);
...
async function singleWeatherRoute(res, requestUrl, kind) {
  ...
  if (kind === "daily") {
    ...
    data = buildBenchmarkData(bundle.benchmark, bundle.history, resolvedLocation);
  } else {
...
function buildBenchmarkData(benchmark, history, location) {
